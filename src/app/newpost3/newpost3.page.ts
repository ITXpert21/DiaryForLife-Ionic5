...
@Component({
  selector: 'app-newpost3',
  templateUrl: './newpost3.page.html',
  styleUrls: ['./newpost3.page.scss'],
})
export class Newpost3Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost3(this.formData).subscribe((result) => {
