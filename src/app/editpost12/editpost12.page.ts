...
@Component({
  selector: 'app-editpost12',
  templateUrl: './editpost12.page.html',
  styleUrls: ['./editpost12.page.scss'],
})
export class Editpost12Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      ...
      this.selectDate = result.dental_selectDate;
      this.doctor = result.dental_doctor;
      this.phone = result.dental_phone;
      this.address = result.dental_address;
      this.result = result.dental_result;
      this.comment = result.dental_comment;
  ...
  async registerNewPost() {
    ...
    this.postService.updatePost12(this.formData).subscribe((result) => {
