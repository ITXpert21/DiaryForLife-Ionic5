...
@Component({
  ...
  templateUrl: './newpost12.page.html',
  styleUrls: ['./newpost12.page.scss'],
})
export class Newpost12Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost12(this.formData).subscribe((result) => {
