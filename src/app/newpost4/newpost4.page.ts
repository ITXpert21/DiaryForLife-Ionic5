...
@Component({
  selector: 'app-newpost4',
  templateUrl: './newpost4.page.html',
  styleUrls: ['./newpost4.page.scss'],
})
export class Newpost4Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost4(this.formData).subscribe((result) => {
