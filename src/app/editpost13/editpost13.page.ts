...
@Component({
  selector: 'app-editpost13',
  templateUrl: './editpost13.page.html',
  styleUrls: ['./editpost13.page.scss'],
})
export class Editpost13Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      ...
      this.birth = result.info_birth;
      this.blood_type = result.info_bloodtype;
      this.phone = result.info_phone;
      this.address = result.info_address;
      this.first_used = result.info_firstused;
      this.comment = result.info_comment;
  ...
  async registerNewPost() {
    ...
    this.formData.append('blood_type', this.blood_type);
    this.formData.append('phone', this.phone);
    this.formData.append('address', this.address);
    this.formData.append('first_used', this.first_used);
    ...
    this.postService.updatePost13(this.formData).subscribe((result) => {
