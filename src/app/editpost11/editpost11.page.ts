...
@Component({
  selector: 'app-editpost11',
  templateUrl: './editpost11.page.html',
  styleUrls: ['./editpost11.page.scss'],
})
export class Editpost11Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      ...
      this.selectDate = result.eye_selectDate;
      this.doctor = result.eye_doctor;
      this.phone = result.eye_phone;
      this.address = result.eye_address;
      this.result = result.eye_result;
      this.comment = result.eye_comment;
      this.phone = result.eye_phone;
  ...
  async registerNewPost() {
    ...
    this.postService.updatePost11(this.formData).subscribe((result) => {
