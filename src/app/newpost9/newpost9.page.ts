...
@Component({
  selector: 'app-newpost9',
  templateUrl: './newpost9.page.html',
  styleUrls: ['./newpost9.page.scss'],
})
export class Newpost9Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost9(this.formData).subscribe((result) => {
