...
@Component({
  selector: 'app-newpost10',
  templateUrl: './newpost10.page.html',
  styleUrls: ['./newpost10.page.scss'],
})
export class Newpost10Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost10(this.formData).subscribe((result) => {
