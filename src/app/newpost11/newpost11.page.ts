...
@Component({
  selector: 'app-newpost11',
  templateUrl: './newpost11.page.html',
  styleUrls: ['./newpost11.page.scss'],
})
export class Newpost11Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost11(this.formData).subscribe((result) => {
