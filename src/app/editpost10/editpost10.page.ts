...
@Component({
  selector: 'app-editpost10',
  templateUrl: './editpost10.page.html',
  styleUrls: ['./editpost10.page.scss'],
})
export class Editpost10Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      loading.dismiss();
      this.selectDate = result.allergy_selectDate;
      this.allergy = result.allergy;
      this.comment = result.allergy_comment;
  ...
  async registerNewPost() {
    ...
    this.formData.append('allergy', this.allergy);
    ...
    this.postService.updatePost10(this.formData).subscribe((result) => {
