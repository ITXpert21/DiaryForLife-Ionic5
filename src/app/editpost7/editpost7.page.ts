...
@Component({
  selector: 'app-editpost7',
  templateUrl: './editpost7.page.html',
  styleUrls: ['./editpost7.page.scss'],
})
export class Editpost7Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      loading.dismiss();
      this.selectDate = result.cholesterol_selectDate;
      this.ldl_bad = result.cholesterol_ldl;
      this.hdl_good = result.cholesterol_hdl;
      this.total = result.cholesterol_total;
      this.comment = result.cholesterol_comment;
  ...
  async registerNewPost() {
    ...
    this.formData.append('ldl_bad', this.ldl_bad);
    this.formData.append('hdl_good', this.hdl_good);
    ...
    this.postService.updatePost7(this.formData).subscribe((result) => {
