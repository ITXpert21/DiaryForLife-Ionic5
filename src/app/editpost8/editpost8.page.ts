...
@Component({
  selector: 'app-editpost8',
  templateUrl: './editpost8.page.html',
  styleUrls: ['./editpost8.page.scss'],
})
export class Editpost8Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      loading.dismiss();
      this.selectDate = result.blood_selectDate;
      this.systolic = result.blood_systolic;
      this.diastolic = result.blood_diastolic;
      this.hr = result.blood_hr;
      this.comment = result.blood_comment;
  ...
  async registerNewPost() {
    ...
    this.formData.append('systolic', this.systolic);
    this.formData.append('diastolic', this.diastolic);
    this.formData.append('hr', this.hr);
    ...
    this.postService.updatePost8(this.formData).subscribe((result) => {
