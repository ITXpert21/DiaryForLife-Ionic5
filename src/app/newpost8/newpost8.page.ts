...
@Component({
  selector: 'app-newpost8',
  templateUrl: './newpost8.page.html',
  styleUrls: ['./newpost8.page.scss'],
})
export class Newpost8Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost8(this.formData).subscribe((result) => {
