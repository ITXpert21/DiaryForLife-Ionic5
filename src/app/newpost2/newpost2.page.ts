...
@Component({
  selector: 'app-newpost2',
  templateUrl: './newpost2.page.html',
  styleUrls: ['./newpost2.page.scss'],
})
export class Newpost2Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost2(this.formData).subscribe((result) => {
