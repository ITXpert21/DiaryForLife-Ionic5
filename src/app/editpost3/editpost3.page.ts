...
@Component({
  selector: 'app-editpost3',
  templateUrl: './editpost3.page.html',
  styleUrls: ['./editpost3.page.scss'],
})
export class Editpost3Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      ...
      this.selectDate = result.selectDate;
      this.age = result.age;
      this.business_name = result.business_name;
      this.doctor = result.doctor;
      this.phone = result.phone;
      this.typedoctor = result.typedoctor;
      this.address = result.address;
      this.weight = result.weight;
      this.height = result.height;
      this.blood_pressure = result.blood_pressure;
      this.pulse = result.pulse;
  ...
  async registerNewPost() {
    ...
    this.formData.append('business_name', this.business_name);
    ...
    this.formData.append('blood_pressure', this.blood_pressure);
    this.formData.append('pulse', this.pulse);
    ...
    this.postService.updatePost3(this.formData).subscribe((result) => {
