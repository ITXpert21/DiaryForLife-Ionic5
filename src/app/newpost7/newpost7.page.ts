...
@Component({
  selector: 'app-newpost7',
  templateUrl: './newpost7.page.html',
  styleUrls: ['./newpost7.page.scss'],
})
export class Newpost7Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost7(this.formData).subscribe((result) => {
