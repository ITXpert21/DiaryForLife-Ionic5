...
@Component({
  selector: 'app-newpost6',
  templateUrl: './newpost6.page.html',
  styleUrls: ['./newpost6.page.scss'],
})
export class Newpost6Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost6(this.formData).subscribe((result) => {
