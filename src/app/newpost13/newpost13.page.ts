...
@Component({
  selector: 'app-newpost12',
  templateUrl: './newpost13.page.html',
  styleUrls: ['./newpost13.page.scss'],
})
export class Newpost13Page implements OnInit {
  categoryId : any;
  selectedVideo = false;
  ...
  async registerNewPost() {
    ...
    this.postService.createPost13(this.formData).subscribe((result) => {
