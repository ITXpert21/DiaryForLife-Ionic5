...
@Component({
  selector: 'app-editpost4',
  templateUrl: './editpost4.page.html',
  styleUrls: ['./editpost4.page.scss'],
})
export class Editpost4Page implements OnInit {
  categoryId : any;
  categoryName : any;
  selectedVideo = false;
  ...
  async getPostById(){
    ...
    this.postService.getPostById(postData).subscribe((result) => {
      loading.dismiss();
      this.selectDate = result.hos_selectDate;
      this.age = result.hos_age;
      this.hospital = result.hospital;
      this.doctor = result.hos_doctor;
      this.phone = result.hos_phone;
      this.typedoctor = result.hos_typedoctor;
      this.address = result.hos_address;
      this.treatment = result.hos_treatment;
      this.reason = result.hos_reason;
      this.stay = result.hos_stay;
      this.diagnosis = result.hos_diagnosis;
      this.comment = result.hos_comment;
  ...
  async registerNewPost() {
    ...
    this.formData.append('hospital', this.hospital);
    this.formData.append('doctor', this.doctor);
    this.formData.append('phone', this.phone);
    this.formData.append('typedoctor', this.typedoctor);
    this.formData.append('address', this.address);
    this.formData.append('treatment', this.treatment);
    this.formData.append('reason', this.reason);
    this.formData.append('stay', this.stay);
    this.formData.append('diagnosis', this.diagnosis);
    ...
    this.postService.updatePost4(this.formData).subscribe((result) => {
